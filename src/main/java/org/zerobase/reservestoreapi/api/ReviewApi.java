...
public class ReviewApi {
  ...
  public ResponseEntity<?> updateReview(
    ...
    return ResponseEntity.ok(reviewService.updateReview(reviewRequest, reviewId, storeId, memberPrincipal.getUsername()));
  }

  @DeleteMapping("/{reviewId}")
  public ResponseEntity<?> deleteReview(@PathVariable Long storeId, @PathVariable Long reviewId, @AuthenticationPrincipal MemberPrincipal memberPrincipal) {
