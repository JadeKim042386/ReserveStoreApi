...
public record StoreDto(
  ...
  private static Set<String> generateBookingTimes(LocalTime startTime, LocalTime lastTime, Integer intervalTime) {
    Set<String> times = new LinkedHashSet<>();
    for (LocalTime time = startTime; time.isBefore(lastTime); time = time.plusMinutes(intervalTime)) {
