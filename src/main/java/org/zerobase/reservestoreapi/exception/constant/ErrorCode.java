...
public enum ErrorCode {
    ...
    ALREADY_EXISTS_USERNAME_OR_NICKNAME(HttpStatus.BAD_REQUEST, "already exists nickname or username"),
    ...
    //sign up
    INVALID_INTERVAL_TIME(HttpStatus.BAD_REQUEST, "intervalTime must not be greater than lastTime - startTime"),
    ;
